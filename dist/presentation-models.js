(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("augmentedjs-next"), require("presentation-request"), require("presentation-storage"));
	else if(typeof define === 'function' && define.amd)
		define("presentation-models", ["augmentedjs-next", "presentation-request", "presentation-storage"], factory);
	else if(typeof exports === 'object')
		exports["presentation-models"] = factory(require("augmentedjs-next"), require("presentation-request"), require("presentation-storage"));
	else
		root["presentation-models"] = factory(root["Augmented"], root["presentation-request"], root["presentation-storage"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_augmentedjs_next__, __WEBPACK_EXTERNAL_MODULE_presentation_request__, __WEBPACK_EXTERNAL_MODULE_presentation_storage__) {
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _presentationRequest.sync)(method, model, options);
...
var _presentationStorage = __webpack_require__(/*! presentation-storage */ "presentation-storage");
...
class LocalStorageCollection extends _augmentedjsNext2.default.AbstractCollection {
  constructor(models, options) {
    ...
    this._storage = _presentationStorage.LocalStorageFactory.getStorage(this._persist, DEFAULT_NAMESPACE);
  }
...
module.exports.Model = _model2.default;
module.exports.Collection = _collection2.default;
module.exports.LocalStorageCollection = _localStorageCollection2.default;
module.exports.PaginatedCollection = _paginated2.default;
module.exports.PaginationFactory = _factory2.default;
module.exports.PAGINATION_API_TYPE = _api2.default;
